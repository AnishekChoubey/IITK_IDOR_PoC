...
> **Disclaimer:** The DDIA has claimed to have fixed this vulnerability, so making the PoC public is no harm to anyone and will benefit cybersecurity aspirants to understand where flaws can lie even in big institutions, IRONICALLY the ones who have launched a whole new degree for this particular field. This repo is completely for EDUCATIONAL purpose and no harm is intended.
